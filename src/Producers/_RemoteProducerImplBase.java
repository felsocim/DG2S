                ...
                implements Producers.RemoteProducer, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("setReadyToGo", new java.lang.Integer (6));
    _methods.put ("pretype", new java.lang.Integer (7));
    _methods.put ("generate", new java.lang.Integer (8));
    _methods.put ("acquire", new java.lang.Integer (9));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 6:  // Producers/RemoteProducer/setReadyToGo
       {
       ...
       case 7:  // Producers/RemoteProducer/pretype
       {
       ...
       case 8:  // Producers/RemoteProducer/generate
       {
         this.generate ();
         out = $rh.createReply();
         break;
       ...
       case 9:  // Producers/RemoteProducer/acquire
       {
