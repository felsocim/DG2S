                ...
                implements Producers.RemoteProducer, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("_get_empty", new java.lang.Integer (7));
    _methods.put ("setReadyToGo", new java.lang.Integer (8));
    _methods.put ("setInfiniteRessources", new java.lang.Integer (9));
    _methods.put ("pretype", new java.lang.Integer (10));
    _methods.put ("generate", new java.lang.Integer (11));
    _methods.put ("acquire", new java.lang.Integer (12));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 7:  // Producers/RemoteProducer/_get_empty
       {
         boolean $result = false;
         $result = this.empty ();
         out = $rh.createReply();
       ...
       case 8:  // Producers/RemoteProducer/setReadyToGo
       {
       ...
       case 9:  // Producers/RemoteProducer/setInfiniteRessources
       {
       ...
       case 10:  // Producers/RemoteProducer/pretype
       {
       ...
       case 11:  // Producers/RemoteProducer/generate
       {
         this.generate ();
         out = $rh.createReply();
         break;
       ...
       case 12:  // Producers/RemoteProducer/acquire
       {
       ...
       case 13:  // Producers/RemoteProducer/_toString
       {
         String $result = null;
