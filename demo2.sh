...
xterm -e java -classpath ./src/libs/cli.jar:./src:./out Producers.Producer -i 1 -t wood -c 5 -max 3 -f 1000 -I &
xterm -e java -classpath ./src/libs/cli.jar:./src:./out Producers.Producer -i 2 -t marble -c 5 -max 2 -f 1000 -I &
xterm -e java -classpath ./src/libs/cli.jar:./src:./out Producers.Producer -i 3 -t wood -c 3 -max 3 -f 1000 -I &
xterm -e java -classpath ./src/libs/cli.jar:./src:./out Producers.Producer -i 4 -t marble -c 2 -max 2 -f 1000 -I &
...
xterm -e java -classpath ./src/libs/cli.jar:./src:./out Consumers.Consumer -i Berger -tw 30 -tm 30 -c -o &
xterm -e java -classpath ./src/libs/cli.jar:./src:./out Consumers.Consumer -i Christine -tw 30 -tm 30 -I &
